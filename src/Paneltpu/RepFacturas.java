 ...
 * @author GATEWAY1-
 */
public class RepFacturas extends javax.swing.JDialog {
     ...
     */
    public RepFacturas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Reporte de Facturas");

        jLabel7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel7.setText("Fecha inicial");

        JcTipo.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        JcTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "TODOS", "NORMAL", "ESPECIAL" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(JcTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(112, 112, 112))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(JcTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9))
                .addGap(45, 45, 45)
    ...
    private void setreport(String f1, String f2, String n, String tipo) {
        try {
...
//            Agregar parametros al reporte
            ...
            parametros.put("n", n);
            parametros.put("serie", tipo);
            parametros.put("imag", fd.getimagenreporte(user));
            JasperReport jasper = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportesrep/VentasxSerie_E.jasper"));
            JasperPrint print = JasperFillManager.fillReport(jasper, parametros, u.getCpttpu());
            JasperViewer ver = new JasperViewer(print, false); //despliegue de reporte
            this.dispose();
            ver.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
            ver.setTitle("Reporte de facturas");
            ver.setVisible(true);
            //Pequeña funcion para regresar la ventana y no tenerla que volver a abrir
            regresarventana(ver);
        } catch (JRException ex) {
            Logger.getLogger(RepFacturas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    /**
     * toma y valida datos necesarios para el reporte
     */
    private void validadatos() {
        ...
        switch (JcTipo.getSelectedIndex()) {
            //No importa que tipo sea, traera todos
            case 0:
                tipo = "";
                break;
            case 1:
            case 2:
                //Obtiene el primer digito del tipo de factura
                tipo = JcTipo.getSelectedItem().toString().charAt(0) + "";
                break;
        }
        setreport(f1, f2, n, tipo);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RepFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RepFacturas dialog = new RepFacturas(new javax.swing.JFrame(), true);
