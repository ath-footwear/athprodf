...
////                System.out.println("dfacturas "+sql);
            ...
            try {
                c.rollback();
                Logger.getLogger(sqlfactura_tpu.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex1) {
                Logger.getLogger(sqlfactura_tpu.class.getName()).log(Level.SEVERE, null, ex1);
            }
            return false;
        }
